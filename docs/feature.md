...
[스택 사이즈](#user-content-fn-4)[^4] 1000배율, 자원 30배율, 컨베이어 30배율, 용광로 30배율, 채석장 10배율, 스크랩 10배율, 컴포 10배율, 전기생산 2배율, 밤 3배속, 보급낙하속도 2배속, 믹싱 테이블 2배속으로 설정되어 있다.

{% hint style="warning" %}
[저장 용기](#user-content-fn-5)[^5]가 있는 아이템의 저장 용기는 스택 배율에서 제외되고, 유황은 자원배율과 별도로 10배이다.
{% endhint %}
