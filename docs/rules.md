...
1인당 설치 가능한 엔티티의 개수: 2만개로 제한. 건물 당 사용할 수 있는 엔티티의 개수: 토대 1500개, 삼각토대 3000개, 벽 4500개, 반벽 2250개로 제한. 어떤 방식으로든 건물 당 엔티티가 위 기준을 초과하는 경우 한 시즌동안 임시 밴 처리 되며 본인이 설치한 모든 엔티티는 제거됩니다. 여기에 정의되지 않은 엔티티 테러는 어드민의 재량에 따라 처리합니다.
