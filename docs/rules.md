...
세부적인 변경사항은 디스코드 [규칙](https://discordapp.com/channels/878836708379090944/944478590274248734) 채널을 참고하십시오.
...
● 다른 사용자의 소셜 미디어 계정 링크를 포함하여 개인 정보를 공유하는 것은 허용되지 않습니다.
...
* 만약 투표가 생성된 이유가 서술되어있는 [내부 URL](#user-content-fn-1)[^1]이 존재하는 경우, 해당 링크를 투표에 답장 기능으로 명시해야 합니다.
...
{% hint style="info" %}
규칙을 준수하지 않는 경우 투표 생성을 제한하기 위해 [타임아웃](https://support.discord.com/hc/ko/articles/4413305239191-Time-Out-FAQ) 될 수 있습니다.
{% endhint %}
...
● 비정상적인 게임 플레이 패턴 - 비정상적인 게임 플레이 패턴이 의심되는 경우 [EAC](https://namu.wiki/w/EasyAntiCheat#s-2)로부터 부정 프로그램 사용 여부 확인을 위해 서버로부터 시즌밴 될 수 있습니다.
